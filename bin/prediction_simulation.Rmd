...
```{r simulate_data}
n.genes <- c(c(100, 500), seq(1000, 10000, 500))
n.genes <- c(100, 500)
...
res %>% 
  ...
  lapply(function(x){
    ...
    model.order <- c( "mars", "glm", "lasso", "elastic.net.0.9", "elastic.net.0.5", "elastic.net.0.1", "ridge", "svm.linear", "random.forests", "naive.bayes", "neural.network")
