...
rpkm <- fread("../../data/2017-09-13_gtex_data/GTEx_Analysis_v6p_RNA-seq_RNA-SeQCv1.1.8_gene_rpkm.gct", sep = "\t", header = TRUE, skip = 2)
```
...
sample.metadata <- as.data.frame(fread("../../data/2017-09-13_gtex_data/GTEx_Data_V6_Annotations_SampleAttributesDS.txt", header = TRUE, sep = "\t", na.strings = c("NA", "")))
```
...
remove.samples <- sample.metadata[is.na(sample.metadata$SMTS), "SAMPID"]
rpkm <- rpkm[,.SD, .SDcols=-remove.samples]
```
