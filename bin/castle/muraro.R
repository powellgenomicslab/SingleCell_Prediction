...
target = readRDS("data/2018-04-15_pancreas_muraro/muraro.rds")
...
#       acinar alpha beta delta ductal endothelial epsilon gamma mesenchymal
# alpha   0.01  0.83 0.05  0.06   0.00           0    0.33  0.13        0.00
# beta    0.00  0.00 0.61  0.01   0.00           0    0.00  0.00        0.00
# delta   0.01  0.14 0.27  0.85   0.01           0    0.67  0.47        0.01
# gamma   0.00  0.00 0.02  0.04   0.00           0    0.00  0.37        0.00
# other   0.98  0.03 0.05  0.05   0.98           1    0.00  0.04        0.99

#        acinar alpha beta delta ductal endothelial epsilon gamma mesenchymal
# alpha      2   670   22    11      0           0       1    13           0
# beta       0     0  273     2      1           0       0     0           0
# delta      3   115  120   164      2           0       2    47           1
# gamma      0     0    9     7      1           0       0    37           0
# other    214    27   24     9    241          21       0     4          79
