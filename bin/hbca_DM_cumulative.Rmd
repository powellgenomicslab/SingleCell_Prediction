...
predict.all <- function(dataset){
  TrainPredict(dataset$dataset.params, dataset$training.params, methods = c("glm", "elasticNet", "earth", "svmPoly", "rf"), n.rep = 2, n.cores = 2)
}

res <- lapply(DC.datasets[1:3], predict.all)
```
